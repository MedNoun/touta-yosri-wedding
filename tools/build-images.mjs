...
const SOURCES = [
  /* La photographie d'ouverture. Elle sert trois fois — le hero, le
     tirage qui sort de l'enveloppe et l'og:image — et c'est
     ...
     remplace une autre. Elle ne reparaît donc pas dans la galerie :
     photo-3.jpg, le regard, y tient sa place. */
  { src: 'assets/photos/photo-5.jpg', name: 'couple-embrace', widths: [480, 640, 800] },
  { src: 'assets/photos/photo-3.jpg', name: 'couple-gaze',    widths: [480, 640, 800] },
